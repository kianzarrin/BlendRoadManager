namespace NodeController.Patches {
    ...
    static class RefreshJunctionData {
        ...
        static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, MethodBase original) {
            ...
            index = codes.Search(_c => _c.LoadsField(f_pavementWidth), 1); //main left
            ...
            index = codes.Search(_c => _c.LoadsField(f_pavementWidth), 2); //A left
            codes.InsertInstructions(index + 1, //after
                new[] {
                    ldSegmentIDA.Clone(), 
            ...
            index = codes.Search(_c => _c.LoadsField(f_pavementWidth), 3); //main right
            codes.InsertInstructions(index + 1, //after
                new[] {
                    ldSegmentID.Clone(), 
            ...
            index = codes.Search(_c => _c.LoadsField(f_pavementWidth), 4); //B right
            codes.InsertInstructions(index + 1, //after
                new[] {
                    ldSegmentIDB.Clone(), 
            ...
            index = codes.Search(_c => _c.LoadsField(f_pavementWidth), 5); //.z
            codes.InsertInstructions(index + 1, //after
                new[] {
                    ldSegmentID.Clone(), 
            ...
            index = codes.Search(_c => _c.LoadsField(f_pavementWidth), 6); //.w
            codes.InsertInstructions(index + 1, //after
                new[] {
                    ldSegmentID.Clone(), 
        ...
        static MethodInfo mModifyPavement = GetMethod(typeof(RefreshJunctionData), nameof(ModifyPavement));
